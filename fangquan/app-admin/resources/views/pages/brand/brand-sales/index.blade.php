    ...
    <div class="wrapper-box">
        ...
        <div class="content-box">
            ...
            <div class="button-box">
                <div class="add-btn">
                    <a href="{{route('brand.brand-sales.edit',['id'=> $id ?? 0, 'brand_id' => $brand_id ?? 0])}}">新增负责区域</a>
                </div>
            </div>
                ...
                <form method="GET">
                    ...
                    <div class="row">
                        <div class="columns">
                            ...
                            <a href="{{route('brand.brand-sales.index',['brand_id' => $brand_id])}}" class="button reset-btn">重置</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <table class="table" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>{{$item['sale_area_names'] or ''}}</td>
                    <td>{{$item['name'] or ''}}</td>
                    <td>{{$item['telphone'] or ''}}</td>
                    <td>
                        <a class="icon-edit" title="编辑" href="{{route('brand.brand-sales.edit',['id'=>$item['id'], 'brand_id' => $item['brand_id']])}}">
                            <i class="iconfont">&#xe626;</i>
                        </a>
