...
class  ProviderBrandStoreForm extends Form
{
    /**
     * @var ProviderEntity
     */
    ...
    public function validation()
    {
        ...
        $provider_entity->is_ad = array_get($this->data, 'is_ad', 0) ?? 0;
        $provider_entity->rank = array_get($this->data, 'rank', 0) ?? 0;
        $provider_entity->company_type = array_get($this->data, 'company_type') ?? 0;
        ...
        $provider_entity->status = array_get($this->data, 'status') ?? 0; //公司状态
